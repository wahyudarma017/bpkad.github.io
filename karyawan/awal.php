            ...
            <div class="main-content">
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                            ...
                            <form action="dt_absen_sv.php" method="post">
                                ...
                                <table class="table table-borderless table-striped table-earning" >
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>masuk</td>
                                                <td><input type="text" class="form-control" value="<?php echo date('l, d-m-Y h:i:s a' ); ?>" name="masuk" readonly="" ></td>
                                            </tr>
                        ...
                        <div class="row">
                           <div class="table-responsive table--no-card m-b-30">
                            <form action="dt_absen_pulang.php" method="post">
                                <div class="form-group">
                                <table class="table table-borderless table-striped table-earning" >
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>pulang</td>
                                                <td><input type="text" class="form-control" value="<?php echo date('l, d-m-Y h:i:s a' ); ?>" name="pulang" readonly="" ></td>
                                            </tr>
