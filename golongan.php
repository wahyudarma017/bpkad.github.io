            ...
            <nav class="navbar-mobile">
                <div class="container-fluid">
                   ...
                   <li>
                        ...
                        <li>
                            <a href="golongan.php">
                                <i class="fas fa-signal"></i>Golongan Pegawai</a>
                        </li>
                        <li>
                ...
                <nav class="navbar-sidebar">
                    ...
                    <li>
                        ...
                        <li class="active has-sub">
                            <a href="golongan.php">
                                <i class="fas fa-signal"></i>Data Golongan</a>
                        </li>
                        <li>
                            <a href="data_absen.php">
                                <i class="fas fa-calendar-alt"></i>Data Absen</a>
                                    ...
                                    <table class="table table-borderless table-striped table-earning">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td> <a href="hapus_golongan.php?id=<?php echo $row['id']; ?>"><button class="btn btn-danger" onclick="return confirm('yakin ingin dihapus?');">Hapus</button></a></td>
