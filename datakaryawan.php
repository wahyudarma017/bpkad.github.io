                    ...
                    <div class="container-fluid">
                        <div class="header-wrap">
                             ...
                             <form class="form-header" action="prospenkar.php" method="POST">
                                <input class="au-input au-input--xl" autocomplete="off" type="text" name="cari" placeholder="Cari nama pegawai" />
                                ...
                                <table class="table table-borderless table-striped table-earning" >
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <input type="text" class="form-control" maxlength="30" required="" name="id_karyawan" autocomplete="off" size="25px" maxlength="25px">    
